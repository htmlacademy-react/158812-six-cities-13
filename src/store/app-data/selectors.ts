...
export const getOffer = (state: State): DetailsOffer | null => state[NameSpace.Data].offer;
...
export const getCommentStatus = (state: State): string => state[NameSpace.Data].statusComment;
